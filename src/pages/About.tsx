  ...
  return (
    <>
      ...
      >
        ...
        desde muy pequeño con la zampoña, flauta dulce y por etapas tocó la
        tarola en la banda colegial, aún cursando la secundaria se animó por la
        guitarra acústica criolla llevándolo a estudiar un curso formativo en el
        MALI, a mediados del 2011 tomó más interés en la batería acústica al
        visitar varias salas de estudio junto a sus amigos de barrio, es cuando
        decide trabajar para comprar su primera batería acústica en el 2012, con
        el tiempo optó por desenvolverse en la percusión por completo, con el
        paso de los años, cursó distintas clases particulares de batería, tuvo
      ...
      >
        ...
        manera se desarrolló como artista. En 2016, participó en La Voz Kids,
        donde quedó como semifinalista del programa. En 2020, le surge la idea
        de formar un proyecto de tributo a la banda Queen, contactándose con
        algunos músicos; sin embargo, al final descubrió que la versatilidad de
        la banda podía ser mejor aprovechada mediante composiciones y covers.
      </SmallMemberInfo>
